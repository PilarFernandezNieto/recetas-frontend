...
<template>
  <AuthenticatedLayout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-700 leading-tight">Nuevo Ingrediente</h2>
    </template>
    <div class="py-12">
          ...
          <div class="bg-white shadow-sm p-4 rounded-md">
            <form @submit.prevent="handleIngrediente()">
              ...
              <div class="my-8">
                <label
                  for="imagen"
                  class="cursor-pointer bg-amber-700 text-white mb-2 py-2 px-4 rounded-md hover:bg-amber-800 focus:ring-2 focus:ring-amber-700"
                >
                  Subir imagen
                </label>
              ...
              <div>
                ...
                <textarea
                  ...
                  class="mt-2 w-full p-2 bg-white border border-gray-300 focus:border-amber-700 focus:ring-amber-700 shadow-sm rounded-md file:bg-amber-50 file:rounded-md"
                ></textarea>
