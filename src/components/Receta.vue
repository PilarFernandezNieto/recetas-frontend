...
<template>
  ...
  >
    <div class="space-y-2 w-full">
        <RouterLink :to="{ name: 'receta', params: { id: receta.id } }" class="hover:text-amber-700 font-black text-2xl cursor-pointer rounded-md transition duration-150 ease-in-out" title="Ver receta">{{ receta.nombre }}</RouterLink>
